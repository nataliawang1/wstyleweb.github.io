<nav class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="/W-Style/admin/servicios/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'servicios') !== false ? 'active' : ''; ?>">🛠️ Servicios</a></li>
        ...
        <li><a href="/W-Style/admin/contactos/index.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'contactos') !== false ? 'active' : ''; ?>">✉️ Contactos</a></li>
    </ul>
